...
% regulatization
theta1_new = Theta1(:,2:size(Theta1,2)); % get rid of the bias term for regularization
...
for t = 1:m,
	% forward first
	a1 = X(t,:); % 1*401 (X already has a bias)
	a1 = a1'; % 401*1
	...
	% accumulate gradient
	delta_2 = delta_2(2:end); % skip sigma2(0) 25*1
