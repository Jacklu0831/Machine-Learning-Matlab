...
[max_val, p] = max(predict, [], 2); % column vector of highest in each row (5000*1)
% p is basically the set of predictions (indices of the max of each row of predict matrix
